...
####################################################################################################
def Start():
  Plugin.AddPrefixHandler(PLUGIN_PREFIX, MainMenu, "CNET TV", "icon-default.png", "art-default.png")
...
def Videos(sender, key, params):
   ...
   for video in XML.ElementFromURL(searchUrl).xpath('/l:CNETResponse/l:Videos/l:Video', namespaces=CNET_NAMESPACE):
